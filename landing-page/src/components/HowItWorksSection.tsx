      ...
      <div className="max-w-[80rem] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {steps.map((step) => (
            ...
            >
              <span className={`text-5xl font-extrabold ${step.color} font-[var(--font-plus-jakarta)]`}>{step.number}</span>
              <h3 className="font-[var(--font-plus-jakarta)] text-xl font-bold text-on-surface mt-4">{step.title}</h3>
